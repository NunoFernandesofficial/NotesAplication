...
class CreateNoteFragment : BaseFragment(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"É necessario um link",Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            Toast.makeText(context,"É necessario um titulo!",Toast.LENGTH_SHORT).show()
        }


        else if (etNoteDesc.text.isNullOrEmpty()){

            Toast.makeText(context,"É necessaria uma descrição",Toast.LENGTH_SHORT).show()
        }
    ...
    private fun checkWebUrl(){
        if (Patterns.WEB_URL.matcher(etWebLink.text.toString()).matches()){
            ...
            Toast.makeText(requireContext(),"O Link não é válido",Toast.LENGTH_SHORT).show()
        }
    }
